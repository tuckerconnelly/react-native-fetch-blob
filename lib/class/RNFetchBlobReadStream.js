...
var _uuid=require('../utils/uuid');var _uuid2=_interopRequireDefault(_uuid);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}

var RNFetchBlob=_reactNativeUniversal.NativeModules.RNFetchBlob;
var emitter=_reactNativeUniversal.DeviceEventEmitter;var
...
function RNFetchBlobReadStream(path,encoding,bufferSize,tick){var _this=this;_classCallCheck(this,RNFetchBlobReadStream);this.tick=10;
if(!path)
...
event=e.event;var detail=e.detail;
...
}_createClass(RNFetchBlobReadStream,[{key:'open',value:function open()
