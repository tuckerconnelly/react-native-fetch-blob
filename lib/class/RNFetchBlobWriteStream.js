...
function RNFetchBlobWriteStream(streamId,encoding,append){_classCallCheck(this,RNFetchBlobWriteStream);
this.id=streamId;
this.encoding=encoding;
this.append=append;
}_createClass(RNFetchBlobWriteStream,[{key:'write',value:function write(
