...
var _uri=require('./utils/uri');var _uri2=_interopRequireDefault(_uri);
var _StatefulPromise=require('./class/StatefulPromise.js');var _StatefulPromise2=_interopRequireDefault(_StatefulPromise);
var _fs=require('./fs');var _fs2=_interopRequireDefault(_fs);
var _uuid=require('./utils/uuid');var _uuid2=_interopRequireDefault(_uuid);
var _base=require('base-64');var _base2=_interopRequireDefault(_base);
var _polyfill=require('./polyfill');var _polyfill2=_interopRequireDefault(_polyfill);
var _android=require('./android');var _android2=_interopRequireDefault(_android);
var _ios=require('./ios');var _ios2=_interopRequireDefault(_ios);
var _net=require('./net');var _net2=_interopRequireDefault(_net);
var _jsonStream=require('./json-stream');var _jsonStream2=_interopRequireDefault(_jsonStream);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}else{return Array.from(arr);}}var

RNFetchBlobSession=_fs2.default.RNFetchBlobSession;var
readStream=_fs2.default.readStream;var
createFile=_fs2.default.createFile;var
unlink=_fs2.default.unlink;var
exists=_fs2.default.exists;var
mkdir=_fs2.default.mkdir;var
session=_fs2.default.session;var
writeStream=_fs2.default.writeStream;var
readFile=_fs2.default.readFile;var
ls=_fs2.default.ls;var
isDir=_fs2.default.isDir;var
mv=_fs2.default.mv;var
cp=_fs2.default.cp;
...
_reactNativeUniversal.AppState.addEventListener('change',function(e){
console.log('app state changed',e);
if(e==='active')
RNFetchBlob.emitExpiredEvent(function(){});
});
}
...
function fetchFile(){var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var method=arguments[1];var url=arguments[2];var headers=arguments.length>3&&arguments[3]!==undefined?arguments[3]:{};var body=arguments[4];
...
var cacheData='';
var info=null;
var _progress=void 0,_uploadProgress=void 0,_stateChange=void 0;
...
default:
promise=_fs2.default.stat(url).
then(function(stat){
total=stat.size;
return _fs2.default.readStream(url,
...
stream.onError(function(err){reject(err);});
...
function fetch(){for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}


var taskId=(0,_uuid2.default)();
var options=this||{};
var subscription=void 0,subscriptionUpload=void 0,stateEvent=void 0,partEvent=void 0;
var respInfo={};var _ref=[].concat(_toConsumableArray(
args));var method=_ref[0];var url=_ref[1];var headers=_ref[2];var body=_ref[3];
...
if(err)
reject(new Error(err,respInfo));else
{
...
promise.progress=function(){for(var _len2=arguments.length,args=Array(_len2),_key2=0;_key2<_len2;_key2++){args[_key2]=arguments[_key2];}
var interval=250;
var count=-1;
var fn=function fn(){};
if(args.length===2){
...
promise.uploadProgress=function(){for(var _len3=arguments.length,args=Array(_len3),_key3=0;_key3<_len3;_key3++){args[_key3]=arguments[_key3];}
var interval=250;
var count=-1;
var fn=function fn(){};
if(args.length===2){
...
function FetchBlobResponse(taskId,info,data){var _this=this;_classCallCheck(this,FetchBlobResponse);
this.data=data;
this.taskId=taskId;
...
case'path':
return _fs2.default.readFile(_this.data,'base64').then(function(b64){return Promise.resolve(_base2.default.decode(b64));});
default:
return _this.data;}
...
case'path':
return _fs2.default.readFile(_this.data,'utf8').
then(function(text){return Promise.resolve(JSON.parse(text));});
default:
...
if(_this.type==='path')
return session(name).add(_this.data);else
{
