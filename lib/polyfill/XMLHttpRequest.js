...
var _index=require('../index.js');var _index2=_interopRequireDefault(_index);
var _XMLHttpRequestEventTarget=require('./XMLHttpRequestEventTarget.js');var _XMLHttpRequestEventTarget2=_interopRequireDefault(_XMLHttpRequestEventTarget);
var _log=require('../utils/log.js');var _log2=_interopRequireDefault(_log);
var _Blob=require('./Blob.js');var _Blob2=_interopRequireDefault(_Blob);
var _ProgressEvent=require('./ProgressEvent.js');var _ProgressEvent2=_interopRequireDefault(_ProgressEvent);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}
...
XMLHttpRequest=function(_XMLHttpRequestEventT){_inherits(XMLHttpRequest,_XMLHttpRequestEventT);_createClass(XMLHttpRequest,[{key:'UNSENT',get:function get()
...
{return UNSENT;}},{key:'OPENED',get:function get()
{return OPENED;}},{key:'HEADERS_RECEIVED',get:function get()
{return HEADERS_RECEIVED;}},{key:'LOADING',get:function get()
{return LOADING;}},{key:'DONE',get:function get()
{return DONE;}}],[{key:'setLog',value:function setLog(
...
log.level(level);
}},{key:'addBinaryContentType',value:function addBinaryContentType(
...
}},{key:'removeBinaryContentType',value:function removeBinaryContentType(
...
}},{key:'UNSENT',get:function get(){return UNSENT;}},{key:'OPENED',get:function get(){return OPENED;}},{key:'HEADERS_RECEIVED',get:function get(){return HEADERS_RECEIVED;}},{key:'LOADING',get:function get(){return LOADING;}},{key:'DONE',get:function get(){return DONE;}}]);

function XMLHttpRequest(){_classCallCheck(this,XMLHttpRequest);
log.verbose('XMLHttpRequest constructor called');var _this=_possibleConstructorReturn(this,(XMLHttpRequest.__proto__||Object.getPrototypeOf(XMLHttpRequest)).call(this));_this.upload=new _XMLHttpRequestEventTarget2.default();_this._readyState=UNSENT;_this._response='';_this._responseText=null;_this._responseHeaders={};_this._responseType='';_this._responseURL='';_this._responseXML='';_this._status=0;_this._statusText='';_this._timeout=60000;_this._sendFlag=false;_this._uploadStarted=false;_this._config={};_this._headers={'Content-Type':'text/plain'};return _this;

}_createClass(XMLHttpRequest,[{key:'open',value:function open(
...
body){var _this2=this;
this._body=body;
if(this._readyState!==XMLHttpRequest.OPENED)
throw'InvalidStateError : XMLHttpRequest is not opened yet.';
var promise=Promise.resolve();
this._sendFlag=true;
log.verbose('XMLHttpRequest send ',body);var
_method=this._method;var _url=this._url;var _headers=this._headers;
...
_this2._task.
stateChange(_this2._headerReceived.bind(_this2)).
uploadProgress(_this2._uploadProgressEvent.bind(_this2)).
progress(_this2._progressEvent.bind(_this2)).
catch(_this2._onError.bind(_this2)).
then(_this2._onDone.bind(_this2));
});
}},{key:'overrideMimeType',value:function overrideMimeType(
...
}},{key:'_headerReceived',value:function _headerReceived(
...
}},{key:'_uploadProgressEvent',value:function _uploadProgressEvent(
...
}},{key:'_progressEvent',value:function _progressEvent(
...
}},{key:'_onDone',value:function _onDone(

resp){var _this4=this;
...
}},{key:'_dispatchReadStateChange',value:function _dispatchReadStateChange(

state){
this._readyState=state;
if(typeof this._onreadystatechange==='function')
this._onreadystatechange();
}},{key:'onreadystatechange',set:function set(
...
return this._status;
}},{key:'statusText',get:function get()
...
}},{key:'responseType',set:function set(
...
}},{key:'isRNFBPolyfill',get:function get()

{
return true;
}}]);return XMLHttpRequest;}(_XMLHttpRequestEventTarget2.default);XMLHttpRequest.binaryContentTypes=['image/','video/','audio/'];exports.default=XMLHttpRequest;