...
var _EventTarget2=require('./EventTarget');var _EventTarget3=_interopRequireDefault(_EventTarget2);
...
FileReader=function(_EventTarget){_inherits(FileReader,_EventTarget);_createClass(FileReader,[{key:'isRNFBPolyFill',get:function get()
...
function FileReader(){_classCallCheck(this,FileReader);var _this=_possibleConstructorReturn(this,(FileReader.__proto__||Object.getPrototypeOf(FileReader)).call(this));_this._readState=0;

log.verbose('file reader const');
_this._result=null;return _this;
}_createClass(FileReader,[{key:'abort',value:function abort()
