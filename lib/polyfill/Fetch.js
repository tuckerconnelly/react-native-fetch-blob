...
function Fetch(config){_classCallCheck(this,Fetch);
...
function RNFetchBlobFetchPolyfill(config){_classCallCheck(this,RNFetchBlobFetchPolyfill);
...
function RNFetchBlobFetchRepsonse(resp){_classCallCheck(this,RNFetchBlobFetchRepsonse);
var info=resp.info();
...
this.rnfbResp=resp;
}_createClass(RNFetchBlobFetchRepsonse,[{key:'rawResp',value:function rawResp()
